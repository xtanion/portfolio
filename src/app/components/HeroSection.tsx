...
const HeroSection = () => {
    return (
        <section className="mr-0 ml-0 w-svw min-h-svh flex flex-col items-center  md:grid md:grid-cols-[max-content_max-content_1fr_max-content_max-content] md:grid-rows-[1fr_max-content_1fr] justify-between flex-1 content-center z-10" id="whoami">
            <div className="md:border-[0.5px] bg-black/60 md:bg-transparent md:backdrop-blur-md md:p-12 p-8 border-[#ffffff40] md:col-start-2 md:row-start-2 md:my-0 my-auto">
                ...
                <div >
                    <a className="bg-transparent border border-teal-300 font-mono text-teal-300 px-4 py-2 transition-colors duration-200 hover:bg-teal-300 hover:text-teal-950 hover:border--400" href="https://www.linkedin.com/in/xtanion/">
                        let&apos;s connect!
                    </a>
                </div>
            </div>
