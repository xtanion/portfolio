...
const HeroSection = () => {
    return (
        <section className="flex flex-col items-start justify-between mx-auto z-10">
            <motion.div initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -100 }} transition={{ duration: 0.5 }} className="border-[0.5px] backdrop-blur-sm p-12 border-[#ffffff40]">
