...
const ProjectComponentR: React.FC<ProjectProps> = ({prop}) => {
    return (
        <div className="project relative grid grid-cols-12 gap-2 items-center mb-20 md:mb-24">
            <div className="project-image block relative z-1 col-start-1 col-end-8 row-start-1 row-end-[-1]">
                <div className="rounded-sm overflow-clip">
                    <img src={prop.imgsrc} className="img w-full object-cover opacity-80" />
                </div>
            </div>
            <div className="project-content text-right block relative col-start-7 col-end-[-1] row-start-1 row-end-[-1]">
                <div>
                    ...
                    <div className="justify-right float-right">
                        <Chips chips={prop.techs}/>
                        <div className="links flex flex-row w-full justify-end">
                            <a href={prop.github}>
...
export default ProjectComponentR;