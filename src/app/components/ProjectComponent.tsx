...
const ProjectComponent: React.FC<ProjectProps> = ({prop}) => {
    const alignImg = prop.right ? "col-start-7 col-end-[-1] row-start-1 row-end-[-1]" : "col-start-1 col-end-8 row-start-1 row-end-[-1]";
    const alignCon = prop.right ? "col-start-1 col-end-8 row-start-1 row-end-[-1]" : "col-start-7 col-end-[-1] row-start-1 row-end-[-1]"
    return (
        <div className="project relative grid grid-cols-12 gap-2 items-center mb-20 md:mb-24">
            <div className={`"project-image block relative col-start-7 col-end-[-1] row-start-1 row-end-[-1]" ${alignImg}`}>
                <div className="rounded-sm overflow-clip">
                    <img src={prop.imgsrc} className="img w-full object-cover opacity-80" />
                </div>
            </div>
            <div className={`"project-content block relative z-1 col-start-1 col-end-8 row-start-1 row-end-[-1]"`}>
                <div>
                    ...
                    <div className="project-desc rounded-md p-6 backdrop-blur-lg bg-slate-900/50 shadow-md">
                        <p className="text-start text-sm md:text-sm">{ prop.desc }</p>
                    </div>
                    <div className="">
                        <Chips chips={prop.techs} />
